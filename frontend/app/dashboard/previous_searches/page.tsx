  ...
  return (
    <div className="px-4 sm:px-6 md:px-12 py-6 md:py-10 flex justify-center">
      <div className="flex flex-col w-full max-w-[800px]\">
            ...
            {/* Timeline */}
   {/* Timeline */}
<div className="grid grid-cols-[32px_1fr] md:grid-cols-[40px_1fr] gap-x-3 md:gap-x-4 bg-card p-4 md:p-8 rounded-xl shadow-sm border border-border">
          ...
          <div className={`flex flex-col py-3 ${!isLast ? 'pb-8' : ''} group`}>
            ...
            >
              ...
              >
                ...
                <p className="text-text-base text-base md:text-lg font-semibold leading-normal mb-2 break-words">
                  {item.symptomsText}
                </p>

                <div className="flex items-center gap-2 text-text-muted text-xs md:text-sm font-medium flex-wrap">
            ...
            {selectedSearch && (
              <div className="mt-8">
                ...
                <div className="bg-card p-4 md:p-6 rounded-xl shadow-sm border border-border mb-6">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex items-center gap-3 flex-wrap text-sm text-text-muted font-medium">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          {selectedSearch.recommendedSpecializationName}
                        </span>
                      </div>
            ...
            <footer className="flex flex-col gap-6 py-12 mt-8 text-center border-t border-border">
              ...
              <p className="text-text-muted text-sm">
                © 2024 CareFind. All rights reserved.
              </p>
